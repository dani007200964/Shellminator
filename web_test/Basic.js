...
function stdinAvailable() { if( stdinBufferPtr >= stdinBuffer.length ){ console.log( "No data!" ); return 0; } console.log( "Data available!" ); return 1; }
function stdinRead() { let ret = -1; if( stdinBufferPtr >= stdinBuffer.length ){ console.log( "Invalid data!" ); return ret; } ret = stdinBuffer[ stdinBufferPtr ]; stdinBufferPtr++; if( stdinBufferPtr >= stdinBuffer.length ){ stdinBuffer.length = 0; stdinBufferPtr = 0; } console.log( "New Char:" ); console.log( ret ); return ret; }
...
var ___start_em_js = Module['___start_em_js'] = 68780;
var ___stop_em_js = Module['___stop_em_js'] = 69294;
